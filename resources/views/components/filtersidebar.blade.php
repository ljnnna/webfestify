...
// Close drawer when clicking outside (additional safety)
...
// Handle window resize - tidak perlu auto close karena selalu drawer
window.addEventListener('resize', function() {
    // Drawer behavior tetap sama di semua ukuran layar
});
</script>