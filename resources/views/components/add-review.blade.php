...
<div class="bg-white rounded-xl shadow-md p-6 border border-gray-100 mt-6">
    ...
    @else
        <div class="flex items-center space-x-3 bg-green-100 border border-green-300 rounded-lg p-4 shadow-inner">
            <div class="text-green-600">
                <i class="fas fa-check-circle fa-lg"></i>
            </div>
            <div class="text-sm text-green-800 font-medium">
                You’ve already submitted a review for this return.<br>
