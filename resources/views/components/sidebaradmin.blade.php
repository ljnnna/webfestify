<div class="fixed top-16 left-0 w-64 h-[calc(100%-4rem)] border-r p-4 bg-white overflow-y-auto z-10">
    ...
    <a href="{{ route('admin.home') }}" class="rounded-full border px-4 py-2 text-center font-semibold hover:bg-purple-100 {{ request()->routeIs('admin.dashboard') ? 'bg-purple-200' : '' }}">Dashboard</a>
