        ...
        <div class="p-6">
            ...
            <form action="{{ route('admin.product.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label class="block text-purple-700 font-semibold mb-2">Product Images (Max 5)</label>
                        <div class="relative w-full h-64 bg-purple-100 rounded-xl flex items-center justify-center cursor-pointer">
                            ...
                            <div class="text-center">
                                ...
                                <small class="text-purple-600">Click to upload</small>
                            </div>
                        </div>
                        <div id="image-preview-info" class="mt-2 hidden">
                            <div class="flex justify-between items-center mb-1">
                                <span class="text-sm text-purple-700 font-semibold">Images (<span id="image-count">0</span>/5)</span>
                                <button type="button" id="clear-all-btn" class="text-xs text-red-500 hover:underline">Clear All</button>
                            </div>
                    ...
                    <div class="space-y-4">
                        <div>
                            <label for="category_id" class="block text-purple-700 font-semibold mb-1">Category</label>
                        ...
                        <div>
                            ...
                            <input type="text" name="name" placeholder="Product name..." class="w-full rounded-lg bg-purple-100 px-4 py-2 focus:ring-2 focus:ring-purple-300" required>
                        </div>

                        <div>
                            <label class="block text-purple-700 font-semibold mb-1">Rental Price</label>
                            <input type="number" name="price" placeholder="e.g. 75000" class="w-full rounded-lg bg-purple-100 px-4 py-2 focus:ring-2 focus:ring-purple-300" required>
                        </div>

                        <div>
                            <label class="block text-purple-700 font-semibold mb-1">Available Amount</label>
                            <input type="number" name="stock_quantity" min="0" class="w-full rounded-lg bg-purple-100 px-4 py-2 focus:ring-2 focus:ring-purple-300" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-6 space-y-4">
                    <div>
                        ...
                        <input type="text" name="description" class="w-full rounded-lg bg-purple-100 px-4 py-2 focus:ring-2 focus:ring-purple-300" required>
                    </div>
                    <div>
                        <label class="block text-purple-700 font-semibold mb-1">Details</label>
                        <input type="text" name="details" class="w-full rounded-lg bg-purple-100 px-4 py-2 focus:ring-2 focus:ring-purple-300" required>
                    </div>
                    <div>
                        <label class="block text-purple-700 font-semibold mb-1">Specification</label>
                        <input type="text" name="specification" class="w-full rounded-lg bg-purple-100 px-4 py-2 focus:ring-2 focus:ring-purple-300" required>
                    </div>
                </div>
