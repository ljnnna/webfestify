    ...
    <div class="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-16 lg:px-12">
        ...
        <div class="px-4 mx-auto text-center md:max-w-screen-md lg:max-w-screen-lg lg:px-36">
            ...
            <div class="flex flex-wrap items-center justify-center mt-8 text-purple-900 sm:justify-between">
                ...
                <a href="https://www.instagram.com" target="_blank" class="mb-5 mr-5 lg:mb-0 hover:text-gray-800 dark:hover:text-gray-400 bg-purple-900 p-2 rounded-lg flex items-center space-x-2">
